...
export class Backend implements backendInterface {
    ...
    async addChapter(arg0: string, arg1: SubjectId, arg2: bigint, arg3: string): Promise<ChapterId> {
        if (this.processError) {
            try {
    ...
    async addExamPaper(arg0: string, arg1: SubjectId, arg2: bigint, arg3: string): Promise<ExamPaperId> {
        if (this.processError) {
            try {
                const result = await this.actor.addExamPaper(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addNote(arg0: string, arg1: string, arg2: ChapterId): Promise<NoteId> {
        if (this.processError) {
            try {
    ...
    async addSubject(arg0: string, arg1: string, arg2: string, arg3: string): Promise<SubjectId> {
        if (this.processError) {
            try {
    ...
    async getAllExamPapers(): Promise<Array<ExamPaper>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllExamPapers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChaptersBySubject(arg0: SubjectId): Promise<Array<Chapter>> {
        if (this.processError) {
            try {
    ...
    async getLatestNotes(arg0: bigint): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestNotes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getNotesByChapter(arg0: ChapterId): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNotesByChapter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async preloadSubjects(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.preloadSubjects();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
